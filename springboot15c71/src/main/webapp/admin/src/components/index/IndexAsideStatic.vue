  ...
  <el-aside class="index-aside" height="100vh" width="210px">
    <div class="index-aside-inner menulist" style="height:100%">
      <div v-for="item in menuList" :key="item.roleName" v-if="role==item.roleName" class="menulist-item" style="height:100%;broder:0;background-color:#FEFEFE">
        <div class="menulistImg" style="backgroundColor:#A966F1;padding:25px 0" v-if="false && menulistStyle == 'vertical'">
          <el-image v-if="'https://cdn.pixabay.com/photo/2021/05/09/18/52/laptop-6241789_960_720.jpg'" src="https://cdn.pixabay.com/photo/2021/05/09/18/52/laptop-6241789_960_720.jpg" fit="cover" />
        </div>
      ...
      this.$nextTick(()=>{
        document.querySelectorAll('.menulist .el-menu-item').forEach(el=>{
          el.addEventListener("mouseenter", e => {
            e.stopPropagation()
            el.style.backgroundColor = "rgba(169, 102, 241, 1)"
          })
