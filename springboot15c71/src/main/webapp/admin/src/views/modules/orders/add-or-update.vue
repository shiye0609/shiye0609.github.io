<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="手机名称" prop="goodname">
          <el-input v-model="ruleForm.goodname" 
              placeholder="手机名称" clearable  :readonly="ro.goodname"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="手机名称" prop="goodname">
              <el-input v-model="ruleForm.goodname" 
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.picture" label="手机图片" prop="picture">
          <file-upload
          tip="点击上传手机图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.picture" label="手机图片" prop="picture">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="秒杀价格" prop="discountprice">
          <el-input v-model="ruleForm.discountprice" 
              placeholder="秒杀价格" clearable  :readonly="ro.discountprice"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="秒杀价格" prop="discountprice">
              <el-input v-model="ruleForm.discountprice" 
                placeholder="秒杀价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="秒杀总价格" prop="discounttotal">
          <el-input v-model="ruleForm.discounttotal" 
              placeholder="秒杀总价格" clearable  :readonly="ro.discounttotal"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="秒杀总价格" prop="discounttotal">
              <el-input v-model="ruleForm.discounttotal" 
                placeholder="秒杀总价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  data() {
	...
	consignee : false,
      ...
      rules: {
          ...
          goodid: [
                { required: true, message: '手机id不能为空', trigger: 'blur' },
          ],
          goodname: [
          ],
          picture: [
