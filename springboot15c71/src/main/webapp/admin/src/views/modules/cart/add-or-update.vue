<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="手机表名" prop="tablename">
          <el-input v-model="ruleForm.tablename" 
              placeholder="手机表名" clearable  :readonly="ro.tablename"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="手机表名" prop="tablename">
              <el-input v-model="ruleForm.tablename" 
                placeholder="手机表名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="手机id" prop="goodid">
          <el-input v-model="ruleForm.goodid" 
              placeholder="手机id" clearable  :readonly="ro.goodid"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="手机id" prop="goodid">
              <el-input v-model="ruleForm.goodid" 
                placeholder="手机id" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
