  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(169, 102, 241, 1);fontSize:28px;">手机销售平台注册</h1>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("https://cdn.pixabay.com/photo/2021/05/09/18/52/laptop-6241789_960_720.jpg");
		height: 100vh;
		...
		.login-form {
			...
			.rgs-form {
				...
				.btn {
					...
					border-color: #409EFF;
					border-radius: 15px;
					background-color: rgba(169, 102, 241, 1);
				}
