...
import center from '@/views/center'
    ...
    import discusszhekouyongpin from '@/views/modules/discusszhekouyongpin/list'
    import zhekouyongpin from '@/views/modules/zhekouyongpin/list'
...
const routes = [{
	...
	path: '/news',
      ...
      ,{
	path: '/discusszhekouyongpin',
        name: '秒杀手机评论',
        component: discusszhekouyongpin
      }
      ,{
	path: '/zhekouyongpin',
        name: '秒杀手机',
        component: zhekouyongpin
      }
      ,{
	path: '/yonghu',
        name: '用户',
